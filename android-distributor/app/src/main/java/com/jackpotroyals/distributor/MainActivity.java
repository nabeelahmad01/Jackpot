package com.jackpotroyals.distributor;
...
public class MainActivity extends BridgeActivity {
    ...
    private void lockWebViewZoom() {
        ...
        if (ua != null && !ua.contains("JackpotDistributorNative")) {
            settings.setUserAgentString(ua + " JackpotDistributorNative/1.0");
        } else if (ua != null && ua.matches(".*JackpotDistributorNative/\\d+\\.\\d+.*")) {
            settings.setUserAgentString(
                ua.replaceAll("JackpotDistributorNative/\\d+\\.\\d+", "JackpotDistributorNative/1.0")
            );
        }
    }
